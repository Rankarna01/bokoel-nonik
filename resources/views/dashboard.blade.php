...
@section('page_title')
    Beranda - Bakoel Nonik Admin Dashboard
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Beranda</h3>
                <p class="text-subtitle text-muted">Ringkasan data dan aktivitas Bakoel Nonik</p>
            </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $tableCount }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Jumlah Pesanan per Bulan</h4>
                        </div>
                        <div class="card-body">
