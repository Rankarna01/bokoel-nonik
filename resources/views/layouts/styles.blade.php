...
<link rel="stylesheet" href="{{ asset('master/dist/assets/vendors/iconly/bold.css') }}">

<link rel="stylesheet" href="{{ asset('master/dist/assets/vendors/perfect-scrollbar/perfect-scrollbar.css') }}">
...
<link rel="stylesheet" href="{{ asset('master/dist/assets/vendors/simple-datatables/style.css') }}">
